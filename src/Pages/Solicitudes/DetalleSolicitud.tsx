...
export function DetalleSolicitud() {
    ...
    const openEstadoModal = (estadoInicial: EstadoSolicitud | "" = "") => {
    ...
    const handleCambiarEstado = async () => {
        ...
        if (selectedEstado === "APROBADA" && !selectedAlmacenRetiro) {
            addToast({
                variant: "error",
                title: "Error",
                message: "Al aprobar la solicitud debe asignar el almacén de retiro.",
            });
            return;
        }
        ...
        try {
            ...
            if (selectedEstado === "APROBADA" && selectedAlmacenRetiro) {
                payload.idalmacen_retiro = selectedAlmacenRetiro;
            }
        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-wrap items-start justify-between gap-4">
                ...
                <div className="flex flex-wrap items-center gap-3">
                    <Button
                        type="button"
                        onClick={() => openEstadoModal(solicitud.estado === "APROBADA" ? "APROBADA" : "")}
                    ...
                    <CardContent className="p-6">
                        <div className="flex items-start justify-between gap-4">
                            ...
                            <Button
                                ...
                                onClick={() => openEstadoModal("APROBADA")}
                            >
                    ...
                    <div className="w-full max-w-md rounded-2xl bg-white p-6 shadow-xl">
                                ...
                                >
                                    ...
                                    {almacenes.map((almacen) => (
                                        <option key={almacen.idalmacen} value={almacen.idalmacen}>
                                            {almacen.nombre}
                                            {almacen.ciudad?.nombre ? ` — ${almacen.ciudad.nombre}` : ""}
                                        </option>
                                    ))}
                                </select>
                        ...
                        <div className="mt-6 flex justify-end gap-3">
                            ...
                            <Button
                                ...
                                disabled={isUpdatingEstado || !selectedEstado || (selectedEstado === "APROBADA" && !selectedAlmacenRetiro)}
                            >
