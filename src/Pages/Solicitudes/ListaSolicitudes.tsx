            ...
            <Card className="overflow-hidden border-[#EEF1F4]">
                <CardContent className="p-0">
                    ...
                    <div className="flex flex-wrap items-center justify-between gap-4 border-b border-[#EEF1F4] bg-[#FBFBFC] px-6 py-5">
                        ...
                        <div className="group flex h-11 w-full sm:w-[380px] items-center gap-2 rounded-xl border border-[#E7E7E7] bg-white px-3 shadow-sm transition hover:shadow-md focus-within:border-donamed-primary/40 focus-within:ring-4 focus-within:ring-donamed-light">
                                ...
                                <>
                                    {paginatedData.map((solicitud) => (
                                        ...
                                        >
                                            ...
                                            <div className="flex min-w-0 flex-col" title={solicitud.almacen_retiro ? `${solicitud.almacen_retiro.nombre}${solicitud.almacen_retiro.ciudad?.nombre ? ` — ${solicitud.almacen_retiro.ciudad.nombre}` : ""}` : undefined}>
                                                <span className="truncate text-xs">
