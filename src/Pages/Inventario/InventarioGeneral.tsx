            ...
            <Card className="overflow-hidden border-[#EEF1F4]">
                <CardContent className="p-0">
                    ...
                    <div className="flex flex-wrap items-center justify-between gap-4 border-b border-[#EEF1F4] bg-[#FBFBFC] px-6 py-5">
                        ...
                        <div className="group flex h-11 w-full sm:w-[320px] items-center gap-2 rounded-xl border border-[#E7E7E7] bg-white px-3 shadow-sm transition hover:shadow-md focus-within:border-donamed-primary/40 focus-within:ring-4 focus-within:ring-donamed-light">
